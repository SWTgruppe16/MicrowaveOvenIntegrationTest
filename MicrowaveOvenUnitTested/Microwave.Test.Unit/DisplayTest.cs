...
namespace Microwave.Test.Unit
{
    ...
    public class DisplayTest
    {
        ...
        {
            uut.ShowTime(TimeSpan.FromSeconds(5));
        ...
        {
            uut.ShowTime(TimeSpan.FromMinutes(5));
        ...
        {
            uut.ShowTime(TimeSpan.FromMinutes(10).Add(TimeSpan.FromSeconds(15)));
